...
// account functions.
import { login, findSession } from '../../../controllers/user/account/login.js'; // Except this one shouldn't require a logged in user or key
...
export default [
	...
	{ path : '/user/session'                , module : findSession }         ,
