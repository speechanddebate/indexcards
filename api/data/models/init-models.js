...
export default function initModels(sequelize) {
		...
		event.belongsTo(nsdaCategory, { as: "nsda_category_nsda_category", foreignKey: "nsda_category"});
		...
		chapterJudge.belongsTo(person, { as: "person_person", foreignKey: "person"});
		person.hasMany(chapterJudge, { as: "chapter_judges", foreignKey: "person"});
		...
		school.belongsTo(person, { as: "registered_by_person", foreignKey: "registered_by"});
		person.hasMany(school, { as: "schools", foreignKey: "registered_by"});
		session.belongsTo(person, { as: "su_person", foreignKey: "su"});
		person.hasMany(session, { as: "sessions", foreignKey: "su"});
		session.belongsTo(person, { as: "person_person", foreignKey: "person"});
		person.hasMany(session, { as: "person_sessions", foreignKey: "person"});
		...
		round.belongsTo(protocol, { as: "protocol_protocol", foreignKey: "protocol"});
		protocol.hasMany(round, { as: "rounds", foreignKey: "protocol"});
		...
		result.belongsTo(resultSet, { as: "result_set_result_set", foreignKey: "result_set"});
		resultSet.hasMany(result, { as: "results", foreignKey: "result_set"});
		...
		round.belongsTo(site, { as: "site_site", foreignKey: "site"});
		site.hasMany(round, { as: "rounds", foreignKey: "site"});
		...
		round.belongsTo(timeslot, { as: "timeslot_timeslot", foreignKey: "timeslot"});
		timeslot.hasMany(round, { as: "rounds", foreignKey: "timeslot"});
		...
		event.belongsTo(tourn, { as: "tourn_tourn", foreignKey: "tourn"});
		tourn.hasMany(event, { as: "events", foreignKey: "tourn"});
