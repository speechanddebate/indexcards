...
import _housing from  "./housing.js";
import _housingSlots from  "./housing_slots.js";
...
export default function initModels(sequelize) {
  ...
  const housing = _housing.init(sequelize, DataTypes);
  const housingSlots = _housingSlots.init(sequelize, DataTypes);
  ...
  const stats = _stats.init(sequelize, DataTypes);
  ...
  login.belongsTo(person, { as: "person_person", foreignKey: "person"});
  person.hasMany(login, { as: "logins", foreignKey: "person"});
